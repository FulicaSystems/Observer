...
RendererABC::RendererABC(const LogicalDevice& device, const Swapchain& swapchain) : device(device)
{
...
MultiPassRenderer::MultiPassRenderer(const LogicalDevice& device, const Swapchain& swapchain)
...
SinglePassRenderer::SinglePassRenderer(const LogicalDevice& device, const Swapchain& swapchain)
    : RendererABC(device, swapchain)
{
    static_cast(false);
}
